  ...
  <header class="navbar">
    <div class="navbar__inner">
      <nav class="navbar__nav">
        <RouterLink to="/feed" class="navbar__brand">Events</RouterLink>
        <RouterLink to="/feed" class="navbar__link">Feed</RouterLink>
        <RouterLink to="/events" class="navbar__link">Events</RouterLink>
      </nav>

      <div class="navbar__user">
        <RouterLink v-if="auth.user" :to="{ name: 'profile' }" class="navbar__profile-link">
